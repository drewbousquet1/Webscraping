...
read_wb = xlsx.load_workbook('ProduceReport.xslx')
...
write_sheet.cell(last_row+2,3).value = '=SUM(D2:D' + str(last_row) + ')'

write_sheet.cell(last_row+2,2).value = 'Average'
write_sheet.cell(last_row+2,2).font = Font(size=16, bold=True)

write_sheet.cell(last_row+2,3).value = '=Average(C2:C' + str(last_row) + ')'
write_sheet.cell(last_row+2,3).value = '=Average(D2:D' + str(last_row) + ')'
